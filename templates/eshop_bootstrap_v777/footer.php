...
<!-- Реализация скрипта сочетания клавиш CTRL+Enter -->
<script>
    function sendErrorReport() {
        var selectedText = window.getSelection().toString();
        if (selectedText !== "") {
            if (confirm("Вы хотите отправить сообщение об ошибке с выделенным текстом?")) {
                var subject = "Сообщение об ошибке на сайте";
                var body = "Ошибка: " + selectedText;
                
                var xhr = new XMLHttpRequest();
                xhr.open("POST", "/ajax/send-error-report.php", true);
                ...
                xhr.send("subject=" + encodeURIComponent(subject) + "&body=" + encodeURIComponent(body));
            }
        }
    }
